        ...
        <div class="columns">
            <div class="column is-10 is-offset-1">
                <h1 class="title">Questions</h1>
                    ...
                    <article class="message">
                            <div class="message-header">
                                <p>I can't find a particular card!</p>
                            </div>
                            <div class="message-body">
                        ...
                        <article class="message">
                            <div class="message-header">
                                <p>How did you make this site?</p>
                            </div>
                            <div class="message-body">
